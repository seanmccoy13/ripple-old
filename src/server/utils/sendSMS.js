...
export const sendSMS = async (mobile, linkUrl, companyName, firstTime) => {
  try {
    ...
    // const shortUrl = await googl.shorten(linkUrl) // ITS DEPRECATED
    ...
    const body = `Welcome to Ripple. This is your periodic link to complete the survey approved by ${companyName}. Please click ${linkUrl} to complete Ripple.`
    ...
    return await controller.createSendMessages(messageBody, (err, res) => res ? res : err);
